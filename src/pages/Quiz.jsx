        ...
        >
          {
            ({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => {
              ...
              return (
                <Form>
                  <Input type="text" label="Name" placeholder="Quiz Name" id="name" value={name} onChange={handleChange} onBlur={handleBlur} error={touched.name && errors.name} />
                  ...
                  <div className="mb-4 w-full">
                    ...
                    <DatePicker
                      ...
                      minDate={Date.now() + 1 * 1000 * 60 * 60 * 24}
                    />
                  </div>
                  <div className="mb-4 w-full">
                    <label
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-5 ">
                      <label htmlFor="image" className="bg-indigo-600 text-white font-bold  px-4 py-3 rounded-full focus:outline hover:text-[crimson] hover:bg-white w-[30%] h-auto items-center">
                        Choose File
                      </label>
                      <input
                        type="file"
                      ...
                      />
                      <img
                        className="mx-2 mt-6 w-[250px]"
                        src={image}

                      />
                    </div>
                  </div>
                  <button type="submit" disabled={isSubmitting} className="bg-indigo-600 items-center text-lg text-white font-bold px-2 py-2 rounded-xl focus:outline hover:text-[crimson] hover:bg-white w-full">
                    Create Quiz
                  </button>
